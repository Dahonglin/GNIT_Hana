                ...
                /////// 검사결과가 통과이면 ////////////
                    ...
                    ************************************/
                    $.ajax({
                        ...
                        // 5. 비동기 옵션,
                        // 비동기 옵션을 꺼야(false)
                        // 전역 변수 pass에 값을 업데이트 가능 
                        async: false,
                        // 6. 성공처리 : 중복 안하면 OK, 중복은 NO
                        success: function (res) {
                            console.log('중복결과', res);
                            if (res === 'ok') {
                                $("#mid").siblings(".msg")
                                    .text("훌륭한 아이디네요~!")
                                    .addClass("on");
